...
def translate_cot(sentence: str, target_lang: str = 'en', resample: int = 1, **kwargs) -> str:
    ...
    prompt = (inference([f'Translate sentence "Translate this sentence into [{target_lang}] and explain in detail '
                         f'(output_lang={target_lang}, explain={True})." into "{target_lang}":{lang_seq}'],
...
def translate(sentence: str, target_lang: str = 'en', **kwargs) -> str:
    ...
    regex = rf'.+"{stop_seq}'
    prompt = inference([f'Translate sentence "Translate this sentence into [{target_lang}] '
                        f'(output_lang={target_lang}, explain={False})." into "{target_lang}" without explain:{lang_seq}'],
