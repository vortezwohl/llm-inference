...
def translate_cot(sentence: str, target_lang: str = 'en', resample: int = 1, **kwargs) -> str:
    ...
    prompt = (inference([f'Translate sentence "Translate sentence into [{target_lang}] and explain in detail." into "{target_lang}":{lang_seq}'],
...
def translate(sentence: str, target_lang: str = 'en', **kwargs) -> str:
    ...
    stop_seq = '[END]'
    regex = rf'.+"{stop_seq}'
    prompt = (inference([f'Translate sentence "Translate sentence into [{target_lang}] without any explain." into "{target_lang}":{lang_seq}'],
